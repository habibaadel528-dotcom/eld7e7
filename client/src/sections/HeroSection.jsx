      ...
      <div className="mx-auto grid w-full max-w-[1280px] grid-cols-1 items-center gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(480px,1fr)] lg:gap-16">
        <div className="relative z-10 max-w-[725px]">
          ...
          <p className="mt-6 max-w-[680px] text-[17px] leading-8 sm:text-[20px] sm:leading-[32.5px]">
            <span className="text-[#ef5350]">{tr.shopHighlight}</span>
          ...
          <a
            href="#categories"
            className="mt-8 inline-flex h-[60px] w-[250px] items-center justify-center rounded-full bg-[#c94545] px-6 text-xl font-medium text-white transition hover:bg-[#ef5350]"
          >
            {tr.shopNow}
          </a>
        </div>
        ...
        <div className="relative mx-auto h-[500px] w-full max-w-[560px] sm:h-[580px]">
          ...
          <div className="absolute left-[1%] top-[14%] z-20 rounded-bl-[4px] rounded-br-2xl rounded-tl-2xl rounded-tr-2xl bg-[#ef5350] px-5 py-3 text-sm leading-5 text-white shadow-xl sm:left-[4%] sm:top-[17%]">
            {tr.chat1}
          </div>

          <div className="absolute left-[14%] top-[31%] z-20 max-w-[220px] rounded-bl-2xl rounded-br-[4px] rounded-tl-2xl rounded-tr-2xl bg-[#ef5350]/90 px-5 py-3 text-sm leading-5 text-white shadow-xl backdrop-blur-sm sm:left-[18%]">
            {tr.chat2}
          </div>
          ...
          <div className="absolute left-[-2%] top-[47%] z-20 flex items-center gap-3 sm:left-[2%] sm:top-[50%]">
            ...
            <div className="rounded-bl-[4px] rounded-br-2xl rounded-tl-2xl rounded-tr-2xl bg-[#ef5350] px-5 py-3 text-sm leading-5 text-white shadow-xl">
              {tr.chat3}
            </div>
          </div>

          <div className="absolute bottom-[13%] right-[2%] z-20 rounded-bl-2xl rounded-br-[4px] rounded-tl-2xl rounded-tr-2xl bg-[#ef5350]/90 px-5 py-3 text-sm leading-5 text-white shadow-xl backdrop-blur-sm">
            {tr.chat4}
          </div>
          ...
          <div className="absolute bottom-0 left-[3%] z-20 hidden w-36 rounded-2xl border border-[#ef5350] bg-[var(--page-bg)] p-4 shadow-2xl sm:block">
            ...
            <div className="py-3">
              ...
              <p className="m-0 text-sm leading-5 text-[var(--primary-text)] ">{tr.productPrice}</p>
            </div>
