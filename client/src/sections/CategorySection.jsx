...
const icons = [booksIcon, stationeryIcon, schoolIcon, handcraftIcon];
const routes = [
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
          {tr.items.map((category, index) => (
            ...
            >
              ...
              <Link
                to={routes[index]}
                className="mt-8 flex min-h-[52px] w-full items-center justify-center rounded-full bg-[#c94545] px-5 py-[14px] text-base leading-6 text-white transition duration-200 hover:bg-[#ef5350] active:scale-[0.98]"
              >
